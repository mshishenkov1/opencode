...
Ревизия 1.6, 2026-08-21 (ревизия 1.5 — 2026-08-21, ревизия 1.4 — 2026-08-20,
ревизия 1.3 — 2026-08-20, ревизия 1.2 — 2026-08-20, ревизия 1.1 — 2026-08-20,
базовая ревизия 1 — 2026-08-19).
...
- **S-B9. Подпись и объём правок упаковки Desktop.** *(переформулировано ревизией 1.6; прежняя
  ...
  - **Что теперь разрешено менять** в `packages/desktop/electron-builder.config.ts`: (а) добавление
    ...
    `CORP_DESKTOP_UPDATE_URL` (S-B11). Иных правок в файле не вносится.
