export const dict = {
  ...
  "corp.command.login": "Corporate SSO sign-in",
  "corp.command.login.description": "Sign in and get a corporate model key",

  // corp: подпись постоянного пункта навигации «Коннекторы» (S-D2a, S-D2b, S-I1)
  "corp.sidebar.connectors": "Connectors",

  "corp.login.title": "Corporate SSO sign-in",
  "corp.login.hub": "Hub address",
  "corp.login.code": "Confirmation code",
  "corp.login.open": "Open this address in the browser",
  "corp.login.waiting": "Waiting for confirmation…",
  "corp.login.copy": "Copy code",
  "corp.login.copied": "Code copied",
  ...
  "corp.connectors.search": "Search connectors",
  "corp.connectors.empty": "Catalog is empty",
  "corp.connectors.hubDown": "Hub unavailable",
  "corp.connectors.hubDownCached": "Hub unavailable, data from {{at}}",
  "corp.connectors.needsLogin": "Sign-in required",
  "corp.connectors.refresh": "Refresh",
  "corp.connectors.connect": "Connect",
  "corp.connectors.reconnect": "Reconnect",
  "corp.connectors.disconnect": "Disconnect",
  "corp.connectors.permissions": "Permissions",
  "corp.connectors.openHub": "Open in Hub",
  "corp.connectors.login": "Sign in",
  "corp.connectors.deprecated": "deprecated",
  "corp.connectors.stale": "Data is stale, actions unavailable",
  "corp.connectors.presetTitle": "Permissions for {{title}}",
  ...
  "corp.connector.alias": "Technical name",
  "corp.connector.copyLink": "Copy link",
  "corp.connector.linkCopied": "Link copied",
  "corp.connector.linkCopyFailed": "Could not copy the link",
  "corp.connector.verifiedToday": "checked today at {{time}}",
  "corp.connector.verifiedYesterday": "checked yesterday",
  "corp.connector.verifiedOn": "checked on {{date}}",
  ...
  "corp.hubWarning": "Hub responded with an error",

  "corp.error.corp_disabled": "Corporate mode is not configured",
  "corp.error.hub_unavailable": "Hub unavailable",
  "corp.error.hub_invalid_response": "Hub returned an unexpected response",
  "corp.error.login_expired": "Sign-in session expired",
  "corp.error.forbidden": "Access denied",
  "corp.error.invalid_team": "Unknown team",
  "corp.error.team_selection_not_required": "Team selection is not required",
  "corp.error.rate_limited": "Too many attempts, try again later",
  "corp.error.litellm_unavailable": "Key service unavailable",
  "corp.error.litellm_invalid_response": "Key service returned an unexpected response",
  "corp.error.unauthorized": "Sign-in required: no key found",
