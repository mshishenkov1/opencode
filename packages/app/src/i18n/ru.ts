export const dict = {
  ...
  "corp.error.connect.token_rejected": "Доступ не подтверждён: сервер не принял вашу авторизацию",
  "corp.error.connect.method_unavailable":
    "Этим способом коннектор сейчас подключить нельзя — вопрос решается на стороне сервера",
  "corp.error.connect.hub_unreachable": "Связаться с сервисом не удалось, ваши настройки ни при чём",
