export const dict = {
  ...
  "corp.connect.storage":
    "Токен сохраняется на этой машине в файле с правами 0600 и уходит только в саму систему",
  ...
  "corp.error.connect.hub_unreachable":
    "Hub не отвечает. Это не про ваш токен — попробуйте через несколько минут",
