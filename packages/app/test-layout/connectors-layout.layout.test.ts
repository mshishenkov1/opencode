 ...
 *
 * Прогон идёт в обеих ветках флага оформления при 0, 1 и 50 карточках и на всех шести пустых
 * состояниях (S-V12) — это заодно закрывает AC-184 и AC-230 наблюдаемо, по измеренной высоте панели,
 * а не по объявленной высоте контейнера.
 *
...
/** Шесть пустых состояний витрины (S-V12): у двух последних вкладки и шапка не показываются. */
const EMPTY_STATES: { name: string; options: Omit<ShellOptions, "branch"> }[] = [
  ...
  {
    name: "6 «Подключено всё»",
    options: { cards: 0, empty: { text: "Подключено всё", action: "resetFilter" } },
  },
]
