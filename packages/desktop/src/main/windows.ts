...
export function createMainWindow() {
  ...
  const win = new BrowserWindow({
    ...
    // одинаковый у всех каналов (F44), а таблица имён сборок жила в другом файле и с заголовком
    // связана не была: корпоративная сборка донашивала заголовок ванильной.
    title: appName(),
    icon: iconPath(),
