 ...
 *
 * **`oauth: false` — не «пустое поле», а разоружение MCP-OAuth** (MAJ-C ревью `review-i4-rev113-2`).
 ...
 * подключение разрешено строкой 1 таблицы S-V7. Второе следствие того же ключа: S-V25 п.7 требует
