...
export function DialogCorpLogout() {
  const sdk = useSDK()
  ...
  async function run() {
    ...
    setBusy(false)
    // S-A16: после выхода приложение предлагает вход — существующим экраном, новый не заводится.
    if (data.key_removed) dialog.replace(() => <DialogCorpLogin />)
    else dialog.clear()
  }
