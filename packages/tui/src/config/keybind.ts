...
export const Definitions = {
  ...
  // corp: команды корпоративного слоя (S-T1, S-T2)
  corp_connectors: keybind("none", "Open connector catalog"),
  corp_login: keybind("none", "Corporate SSO sign-in"),
...
export const CommandMap = {
  ...
  mcp_list: "mcp.list",
  corp_connectors: "corp.connectors",
  corp_login: "corp.login",
