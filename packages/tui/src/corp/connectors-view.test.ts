...
describe("tui/corp — вкладки фильтра витрины (S-V11, S-T10; AC-217, AC-218)", () => {
  ...
  // третьей вкладки»). Тело самого критерия AC-218 приведено к той же редакции резолюцией
  // DISPUTE-I12-04-01 (98cc2658e3, corp/disputes/dispute-I12-04-ac218-body-not-updated.resolution.json)
  // — расхождение с телом критерия закрыто, тесты ниже проверяют действующую редакцию напрямую.
