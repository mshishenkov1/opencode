 ...
 *
 * Критерий-близнец заведён spec-агентом: AC-346 (rule: S-T11, S-A16, S-Q9 п. (щ)). AC-287 остался
 * привязан к S-D6 — только Desktop: под одним идентификатором не держат два разных наблюдаемых
 * (кнопка разметки Desktop и пункт списка действий терминального диалога).
 *
 ...
 */
describe("AC-346, S-Q9 п.(щ): «Войти»/«Выйти» в TUI видны по authenticated(), третье значение не схлопывается (S-T11, S-A16)", () => {
