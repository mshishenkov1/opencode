...
const icons = {
  ...
  // corp: глиф коннекторов для пункта «Коннекторы» в боковой панели Home (S-D2a, D-17).
  // Тело и viewBox совпадают с именем `mcp` в legacy-наборе (packages/ui/src/components/icon.tsx),
  // чтобы развёрнутая панель и свёрнутая рельса показывали одну и ту же иконку.
  mcp: {
    viewBox: "0 0 20 20",
